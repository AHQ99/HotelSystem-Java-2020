...
public class adminForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("National Identity : ");
        ...
        jLabel20.setText("Add an employee");
        ...
        jButton7.setText("Add an employee");
        ...
        jButton8.setText("view employees");
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "User name", "Password", "Fist name", "last name", "mobile", "gender", "Address"
            }
        ));
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(f3)
                                    .addComponent(f4)
                                    .addComponent(f5, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)))
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGap(40, 40, 40)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        if(jRadioButton1.isSelected() == false && jRadioButton2.isSelected() == false && f1.getText().isEmpty() && f2.getText().isEmpty() && f3.getText().isEmpty() && f4.getText().isEmpty() && f5.getText().isEmpty() && f6.getText().isEmpty() && f7.getText().isEmpty()&& f8.getText().isEmpty()){
                ...
                String account_name=f1.getText();
                String account_pass=f2.getText();
                String firstname=f3.getText();
                String surname=f4.getText();
                String mobile=f5.getText();
                String National_Identity=f6.getText();
                String address=f7.getText();
                String email_address=f8.getText();
               ...
               String userscol=gender;
                ...
                String sql = String.format("INSERT INTO emp(account_name, account_pass, address, email_address, firstname, surname, mobile, National_Identity, userscol)\n"+
                "Values('%s','%s','%s','%s','%s','%s','%s','%s','%s');",
                 account_name, account_pass, address, email_address, firstname, surname, mobile, National_Identity, userscol);
                JOptionPane.showMessageDialog(this,"The employee has been added successfully" , "ERROR", JOptionPane.INFORMATION_MESSAGE);
                f1.setText("");
                f2.setText("");
                f3.setText("");
                f4.setText("");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        String id,uname,fname,lname,phone,gender,add,pass;
        jTable4.setModel(new DefaultTableModel(null,new String[]{"ID", "User name", "Password", "Fist name", "last name", "mobile", "gender", "Address"}));
        ...
        try{
            ...
            Connection con = DriverManager.getConnection(db_url, db_username, db_password);
            Statement st = con.createStatement();
            String sql = "select * from hotel_reservation_db103.emp;";
            ResultSet rs =st.executeQuery(sql);
            while(rs.next()){
                id  = String.valueOf(rs.getInt("emp_id"));
                uname = rs.getString("account_name");
                fname= rs.getString("firstname");
                lname= rs.getString("surname");
                phone= rs.getString("mobile");
                gender= rs.getString("userscol");
                add= rs.getString("address");
                pass  = rs.getString("account_pass");      
               
               
                String tbData[] = {id,uname,pass,fname,lname,phone,gender,add};
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if(jTextField5.getText().isEmpty()){
                ...
                JOptionPane.showMessageDialog(this,"The ID number  has to be filled!!" , "ERROR", JOptionPane.ERROR_MESSAGE);
            }
            else  {
                  
                
                String emoid=jTextField5.getText();
                String Availability="Availabil";
                String sql = String.format("DELETE FROM `hotel_reservation_db103`.`emp` WHERE (`emp_id` = '"+emoid+"');");
                ...
                JOptionPane.showMessageDialog(this,"The  employee with ID number "+jTextField5.getText()+" has been deleted" , "Info", JOptionPane.INFORMATION_MESSAGE);
            }
        jTextField5.setText("");
